...
<head>
    ...
    <meta name="author" content="AL Manrique Jr & README.md">
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav nav-fill w-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Pages/servicos.php">Serviços</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="products-preview">
        ...
        <div class="preview" data-target="p-1">
            ...
            <h3>prod-1</h3>
            <div>
                <p>Venda; Locação; Aparelho Suporte;</p>

            </div>
            <p>As muletas são objetos utilizados como apoio para o corpo humano projetado com o propósito de auxiliar um
                deficiente a caminhar quando uma das extremidades</p>
            <div class="price">R$100,00</div>
        </div>
        ...
        <div class="preview" data-target="p-2">
            ...
            <p>CARACTERISTICAS DESCRITIVAS DO PROD</p>
            <div class="price">R$100,00</div>
        </div>
        ...
        <div class="preview" data-target="p-3">
            <i class="fas fa-times"></i>
            <img src="IMG/muleta.png" alt="">
            <h3>muleta + descricao refinada</h3>
            <div>
                <p>Venda; Locação; Aparelho Suporte;</p>
            </div>
            <p>CARACTERISTICAS DESCRITIVAS DO PROD</p>
    ...
    <footer id="footer" class="container-fluid text-center margin bg-footer">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <a class="suave-hyperlink" target="_blank"
                        href="https://www.google.com/maps/place/Av.+Pereira+da+Silva,+1953+-+Jardim+Santa+Ros%C3%A1lia,+Sorocaba+-+SP,+18095-340/@-23.4829528,-47.4393811,3a,75y,315.94h,89.51t/data=!3m6!1e1!3m4!1sfq0S1H-DquDUErLDJFShFQ!2e0!7i16384!8i8192!4m5!3m4!1s0x94cf6005fc2b59cd:0xaf1a9d3ea1b85180!8m2!3d-23.4828348!4d-47.4395607">Av.
                ...
                <div class="col-lg-4">
                    ...
                    <a href="https://www.linkedin.com/in/dra-j%C3%A9ssica-arantes-a86666153/" class="fa fa-linkedin"
                        target="_blank"></a>
                    <br><br><br>
                    <p>Copyright <a class="suave-hyperlink" target="_blank" href="https://github.com/ALManriqueJR">𝒜𝓁
                            𝒥𝓇</a> - FisioOrthopédicos 2022 ™</p>
                </div>
            </div>
        </div>
    </footer>
